...
wardrobe = {
   'Top': [
       'Red T-Shirt', 'White Blouse', 'Black Crop Top', 'Blue Polo Shirt',
       'Green Sweater', 'Striped Tank Top', 'Yellow Hoodie', 'Purple Silk Shirt',
...
def outfit_selection_loop():
   while True:
       ...
       print("\n✨ Now let's find the perfect outfit for today!")
       # (Continue with outfit selection logic here...)
...
def main():
   ...
   while True:
       ...
       if first_choice == "1":
           print("\n🛒 (Your shopping list would be displayed here)")
           # This is where the shopping list function would be called
           continue  # Return to the main menu
